...
public class ProcessTempLines implements Serializable {
	...
	/*
	 * public void readTempRDD(JavaDStream<String> dStream){ System.out.println(
	 * "Analyzing Temperature data"); forecastTemp = getForecastTemp();
	 * //System.out.println(dStream); System.out.println("Forecasted Temp: " +
	 * forecastTemp); dStream.foreachRDD(new Function<JavaRDD<String>, Void>() {
	 *//**
		* 
		*/
	/*
	 ...
	 *//**
		...
		*//*
		 ...
		 * 
		 * @Override public String call(String data) throws Exception {
		 * 
		 * System.out.println("Checking temperature line...."); JSONObject
		 * jsonObj = new JSONObject(data); String deviceID =
		 * jsonObj.getString("deviceId"); System.out.print(
		 * "Reading data for device: " + deviceID); String location =
		 * ProcessUtility.thermostatLocator.get(deviceID); System.out.println(
		 * " at location: " + location); Double currentTemp =
		 * jsonObj.getDouble("temperature"); System.out.println(
		 * "Current Temperature: " + currentTemp); System.out.println(
		 * "Forecasted Temperature: " + forecastTemp); Double tempDiff =
		 * forecastTemp - currentTemp; if(tempDiff < 0) { //its becoming cold so
		 * increase the temperature System.out.println("Device at " + location +
		 * " should increase the temperature by " + tempDiff + "F"); } else
		 * if(tempDiff > 0) { //its becoming hotter System.out.println(
		 * "Device at " + location + " should decrease the temperature by " +
		 * tempDiff + "F"); } else { System.out.println(
		 * "Tempaerature remains same"); }
		 * 
		 * 
		 * return data; } });
		 * 
